...
function M.apply(c, opts)
  ...
  -- Markdown overlay groups used by neo_notebooks
  hi("@markup.markdown", { fg = text_main })
  hi("@markup.heading.markdown", { fg = text_emph, bold = true })
  hi("@markup.heading.1.markdown", { fg = text_emph, bold = true })
  hi("@markup.heading.2.markdown", { fg = c.gold, bold = true })
  hi("@markup.heading.3.markdown", { fg = c.orange, bold = true })
  hi("@markup.strong.markdown_inline", { fg = c.orange, bold = true })
  hi("@markup.italic.markdown_inline", { fg = text_muted, italic = true })
  hi("@markup.raw.markdown_inline", { fg = text_green })
  hi("@markup.raw.block.markdown", { fg = text_green })
  hi("@punctuation.delimiter.markdown", { fg = text_dim })
